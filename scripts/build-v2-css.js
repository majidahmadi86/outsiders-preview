...
body.page-home .hero-panel .eyebrow::before {
  transform: scaleX(0);
}

body.page-home.hero-enter-active .hero-panel .eyebrow::before {
  transform: scaleX(1);
...
.hero-cascade-item {
  ...
  transition-fill-mode: none;
}

body.page-home.hero-enter-active .hero-cascade-item.is-entered {
  opacity: 1;
  transform: none;
}

body.page-home.hero-enter-done .hero-cascade-item {
  opacity: 1;
  transform: none;
}

html.js .hero-cascade-item {
  animation: heroCascade 0s 2.5s forwards;
}
...
body.page-home.hero-enter-active .hero-stat-enter.is-entered,
body.page-home.hero-enter-done .hero-stat-enter {
  opacity: 1;
  transform: none;
}

html.js .hero-stat-enter {
  animation: heroCascade 0s 2.5s forwards;
}
...
.main-nav a.active, .main-nav a[aria-current="page"] {
  color: var(--ink); border-bottom-color: transparent; font-weight: 400;
}
.main-nav a.active::after,
.main-nav a[aria-current="page"]::after {
  content: "";
...
.main-nav a.active.nav-underline-ready::after,
.main-nav a[aria-current="page"].nav-underline-ready::after {
  transform: scaleX(1);
...
.stepper.is-visible .stepper-step::before,
.stepper.is-visible .roadmap-step::before,
.roadmap-strip.is-visible .stepper-step::before,
.roadmap-strip.is-visible .roadmap-step::before {
  transform: translateX(-50%) scale(1);
  opacity: 1;
}

.stepper.is-visible .stepper-step:nth-child(1)::before,
.stepper.is-visible .roadmap-step:nth-child(1)::before,
.roadmap-strip.is-visible .stepper-step:nth-child(1)::before,
.roadmap-strip.is-visible .roadmap-step:nth-child(1)::before { transition-delay: 0.15s; }
.stepper.is-visible .stepper-step:nth-child(2)::before,
.stepper.is-visible .roadmap-step:nth-child(2)::before,
.roadmap-strip.is-visible .stepper-step:nth-child(2)::before,
.roadmap-strip.is-visible .roadmap-step:nth-child(2)::before { transition-delay: 0.23s; }
.stepper.is-visible .stepper-step:nth-child(3)::before,
.stepper.is-visible .roadmap-step:nth-child(3)::before,
.roadmap-strip.is-visible .stepper-step:nth-child(3)::before,
.roadmap-strip.is-visible .roadmap-step:nth-child(3)::before { transition-delay: 0.31s; }
.stepper.is-visible .stepper-step:nth-child(4)::before,
.stepper.is-visible .roadmap-step:nth-child(4)::before,
.roadmap-strip.is-visible .stepper-step:nth-child(4)::before,
.roadmap-strip.is-visible .roadmap-step:nth-child(4)::before { transition-delay: 0.39s; }
.stepper.is-visible .stepper-step:nth-child(5)::before,
.stepper.is-visible .roadmap-step:nth-child(5)::before,
.roadmap-strip.is-visible .stepper-step:nth-child(5)::before,
.roadmap-strip.is-visible .roadmap-step:nth-child(5)::before { transition-delay: 0.47s; }

.stepper.is-visible .stepper-step p,
.stepper.is-visible .roadmap-step p,
.roadmap-strip.is-visible .stepper-step p,
.roadmap-strip.is-visible .roadmap-step p {
  opacity: 1;
}

.stepper.is-visible .stepper-step:nth-child(1) p,
.stepper.is-visible .roadmap-step:nth-child(1) p,
.roadmap-strip.is-visible .stepper-step:nth-child(1) p,
.roadmap-strip.is-visible .roadmap-step:nth-child(1) p { transition-delay: 0.35s; }
.stepper.is-visible .stepper-step:nth-child(2) p,
.stepper.is-visible .roadmap-step:nth-child(2) p,
.roadmap-strip.is-visible .stepper-step:nth-child(2) p,
.roadmap-strip.is-visible .roadmap-step:nth-child(2) p { transition-delay: 0.43s; }
.stepper.is-visible .stepper-step:nth-child(3) p,
.stepper.is-visible .roadmap-step:nth-child(3) p,
.roadmap-strip.is-visible .stepper-step:nth-child(3) p,
.roadmap-strip.is-visible .roadmap-step:nth-child(3) p { transition-delay: 0.51s; }
.stepper.is-visible .stepper-step:nth-child(4) p,
.stepper.is-visible .roadmap-step:nth-child(4) p,
.roadmap-strip.is-visible .stepper-step:nth-child(4) p,
.roadmap-strip.is-visible .roadmap-step:nth-child(4) p { transition-delay: 0.59s; }
.stepper.is-visible .stepper-step:nth-child(5) p,
.stepper.is-visible .roadmap-step:nth-child(5) p,
.roadmap-strip.is-visible .stepper-step:nth-child(5) p,
.roadmap-strip.is-visible .roadmap-step:nth-child(5) p { transition-delay: 0.67s; }
...
.why-card.is-visible .card-icon svg path,
.why-card.is-visible .card-icon svg circle {
  stroke-dasharray: 120;
  stroke-dashoffset: 120;
  animation: olIconDraw 0.9s ease forwards;
}
...
.review-card::before {
  ...
  pointer-events: none;
  transform: scale(0.8);
  transition: opacity 0.55s cubic-bezier(0.22, 1.15, 0.36, 1), transform 0.55s cubic-bezier(0.22, 1.15, 0.36, 1);
}
...
.review-card.is-visible .quote,
.review-card.is-visible .author {
  opacity: 1;
  transform: none;
}
...
.finder-option.is-selecting {
  animation: finderSweep 0.3s ease;
}

@keyframes finderSweep {
  0% { box-shadow: inset 4px 0 0 0 var(--ink); }
  100% { box-shadow: inset 0 0 0 1px var(--gold); }
}
...
.finder-result.is-showing {
  animation: finderResultIn 0.55s ease forwards;
}

.finder-result.is-showing .finder-result-rule {
  animation: finderRuleDraw 0.8s ease 0.1s forwards;
}

@keyframes finderResultIn {
  from { opacity: 0; transform: translateY(16px); }
  to { opacity: 1; transform: none; }
}

@keyframes finderRuleDraw {
...
.hero-media-frame.frame-ready::after {
  opacity: 1;
  transform: scale(1);
}
...
.checklist-reveal.is-visible .checklist-copy {
  opacity: 1;
  transform: none;
}
...
.checklist-reveal.is-visible .checklist-form {
  opacity: 1;
  transform: none;
}

.lead-form input.focus-cue {
  animation: checklistFocusPulse 1.2s ease 1;
}

@keyframes checklistFocusPulse {
  0%, 100% { box-shadow: 0 0 0 0 transparent; }
  40%, 60% { box-shadow: 0 0 0 2px var(--gold); }
}
...
.stepper-vertical.is-visible::before {
  transform: scaleY(1);
}
...
.stepper-vertical.is-visible .roadmap-block::before,
.stepper-vertical.is-visible .stepper-step::before {
  transform: scale(1);
  opacity: 1;
}

.stepper-vertical.is-visible .roadmap-block:nth-child(1)::before,
.stepper-vertical.is-visible .stepper-step:nth-child(1)::before { transition-delay: 0.15s; }
.stepper-vertical.is-visible .roadmap-block:nth-child(2)::before,
.stepper-vertical.is-visible .stepper-step:nth-child(2)::before { transition-delay: 0.23s; }
.stepper-vertical.is-visible .roadmap-block:nth-child(3)::before,
.stepper-vertical.is-visible .stepper-step:nth-child(3)::before { transition-delay: 0.31s; }
.stepper-vertical.is-visible .roadmap-block:nth-child(4)::before,
.stepper-vertical.is-visible .stepper-step:nth-child(4)::before { transition-delay: 0.39s; }
.stepper-vertical.is-visible .roadmap-block:nth-child(5)::before,
.stepper-vertical.is-visible .stepper-step:nth-child(5)::before { transition-delay: 0.47s; }
